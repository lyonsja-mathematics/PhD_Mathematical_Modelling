...
class UnslantedBraggGrating:
    ...
    output_time_step=1# Output time
        ...
        self.spatial_profiles = df
        
        self.optical_properties = optical_properties_df
...
if __name__ == "__main__":
    ...
    s1 = UnslantedBraggGrating(total_time=0)
    
    assert len(s1.spatial_profiles) == s1.Nx
    assert len(s1.optical_properties) == 1
